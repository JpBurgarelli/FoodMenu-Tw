    ...
    <div className="max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
      ...
      <div className="rounded-xl relative">
        ...
        <div className="absolute w-full h-full bg-black/50 rounded-xl text-white">
          ...
          <button className="border-white bg-white text-black mx-2 absolute bottom-4 transition duration-500 ease-in-out hover:bg-gray-200 hover:text-gray-800 font-semibold">
            Order Now
          </button>
        </div>
        <img
